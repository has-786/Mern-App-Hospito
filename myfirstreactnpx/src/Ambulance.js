...
render()
{
 ...
 <div id = "login-box">
		<div class = "right-box">
			...
			<input type = "text" name = "name" id='1' placeholder="Username" required/><br></br>
			<input type = "text" name = "phone" id='2'  placeholder="phone" required/><br></br>
			<input type = "text" name = "car" id='5'  placeholder="car no." required/><br></br>
			<input type = "password" name = "pass" id='3'  placeholder="password" required/><br></br>
			<input type = "password" name = "password" id='4'  placeholder="Retypepassword" required/><br></br>
			<br></br>
