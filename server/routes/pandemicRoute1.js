...
*/
  ...
  app.post("/getState", (req, res) => {
    ...
    request(url, function (error, response, html) {
      ...
      var arr = [];
      var selector =
        "#node-287111 > div > div.field-collection-container.clearfix > div > div.field-items > div > div > div > div > div.field > div.field-items > div";
	  ...
	  */
      ...
      state["Dadra and Nagar Haveli"] = 1;
      state["Delhi"] = 1;
      state["Goa"] = 1;
      state["Gujarat"] = 1;
      state["Haryana"] = 1;
